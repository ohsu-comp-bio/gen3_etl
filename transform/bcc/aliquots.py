"""A transformer for gen3 project,reads assays bcc, writes to DEFAULT_OUTPUT_DIR."""
import hashlib
import os
...
def transform(output_dir, compresslevel=0):
    ...
    for line in reader('source/bcc/assays.tsv'):
        ...
        aliquot = {'type': 'aliquot', '*samples': {'submitter_id': line['ID_Specimen']}}
        aliquot['*submitter_id'] = '{}'.format(line['ID'])
